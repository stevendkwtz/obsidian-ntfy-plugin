...
export default class NTFYPlugin extends Plugin {
    ...
    async onload() {
        ...
        // RibbonIcon
        this.addRibbonIcon('megaphone', 'Obsidian NTFY Plugin', (_evt: MouseEvent) => {
        ...
        this.addCommand({
            ...
            callback: async () => {
                ...
                const ntfyMessage = Object.assign({}, DEFAULT_EMPTY_MESSAGE, fileMessage);
...
class NTFYModal extends Modal {
    ...
    onOpen() {
        ...
        new Setting(contentEl).setName('Message title').addText((text) =>
            text.onChange((value) => {
        ...
        // Message textbox
        new Setting(contentEl).setName('Message content').addText((text) =>
            text.onChange((value) => {
            ...
            .addText((text) =>
                text
                    ...
                    .onChange(async (value) => {
                        if (!value) value = DEFAULT_SETTINGS.ntfy_server_url;
        ...
        new Setting(containerEl)
            ...
            .addText((text) =>
                text
                    ...
                    .onChange(async (value) => {
                        if (!value) value = DEFAULT_SETTINGS.ntfy_topic;
